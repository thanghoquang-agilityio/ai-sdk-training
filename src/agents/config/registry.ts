...
export const AGENT_CONFIG: AgentConfigRegistry = {
  employee: {
    ...
    flow: [
      ...
      "FORBIDDEN at all times: providing examples when asking for a missing field. When asking for reason, do NOT say 'For example, ...' or 'such as ...' or suggest phrases. Just ask the question.",
      "",
